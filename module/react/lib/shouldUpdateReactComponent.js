goog.provide("module$react$lib$shouldUpdateReactComponent");
goog.require("module$react$lib$warning");
var warning$$module$react$lib$shouldUpdateReactComponent = module$react$lib$warning;
function shouldUpdateReactComponent$$module$react$lib$shouldUpdateReactComponent(prevElement, nextElement) {
          ...
          if (!ownersMatch) {
            ...
            if (typeof nextElement.type !== "string" || nextElement.type === "input" || nextElement.type === "textarea") {
              if (prevElement._owner != null && prevElement._owner._isOwnerNecessary === false || nextElement._owner != null && nextElement._owner._isOwnerNecessary === false) {
                ...
                "production" !== process.env.NODE_ENV ? warning$$module$react$lib$shouldUpdateReactComponent(false, "\x3c%s /\x3e is being rendered by both %s and %s using the same " + "key (%s) in the same place. Currently, this means that " + "they don't preserve state. This behavior should be very " + "rare so we're considering deprecating it. Please contact " + "the React team and explain your use case so that we can " + "take that into consideration.", nextDisplayName || "Unknown Component", 
                prevName || "[Unknown]", nextName || "[Unknown]", prevElement.key) : null;
              }
            }
          }
        }
...
module$react$lib$shouldUpdateReactComponent = shouldUpdateReactComponent$$module$react$lib$shouldUpdateReactComponent;
